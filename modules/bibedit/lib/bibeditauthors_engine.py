...
def perform_request_init():
    ...
    protected_fields = [str(x) for x in range(0, 100)]
    for x in range(10):
        protected_fields[x] = '0' + protected_fields[x]
    for x in ['10', '70', '71']:
        protected_fields.remove(x)
    ...
    scripts = ['jquery.min.js', 'effects.core.min.js',
               ...
               'bibedit_display.js', 'bibeditauthors_engine.js', 'bibedit_keys.js',
               'bibeditauthors_keys.js', 'bibedit_menu.js']
...
def perform_request_ajax(req, recid, uid, data):
    ...
    elif request_type in ('getRecord', 'submit', 'cancel', 
                          'newRecord', 'deleteRecord', 'deleteRecordCache', 
                          'prepareRecordMerge'):
