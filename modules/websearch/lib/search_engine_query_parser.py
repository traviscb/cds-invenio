...
from invenio.logic import to_cnf
...
class SearchQueryParenthesisedParser(object):
    ...
    * substitution_dict: a dictionary mapping strings to other strings.  By
    ...
    def parse(self, token_list, variable_substitution_dict=None):
        ...
        structures, we need to flatten the input structure first.  Such
        token_lists should be passed through
        """
        ###
        # Invariants:
        ...
        while i < len(token_list):
            ...
            if token == '(':
                ...
                if clause_end == -1:
                    raise InvenioWebSearchMismatchedParensError("Mismatched '('")
